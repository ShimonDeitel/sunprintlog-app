...
struct ContentView: View {
    ...
    @State private var editingEntry: ViewEntry?
        ...
        NavigationStack {
            ZStack {
                ...
                if store.entries.isEmpty {
                    ContentUnavailableView("No View Log Entries Yet", systemImage: "square.and.pencil", description: Text("Tap + to add your first entry."))
...
struct EntryEditorView: View {
    ...
    @State private var draft: ViewEntry
    @State private var draftDate: Date = Date()

    init(entry: ViewEntry?) {
        self.entry = entry
        _draft = State(initialValue: entry ?? ViewEntry())
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                TextField("Sunrise/Sunset", text: $draft.kind)
